...
public class AirlineGraph {
    ...
    public static void main(String[] args) {
        ...
        g.addCity("AD","Abu Dhabi");
        g.addCity("LHR","Lahore");
        g.addCity("KHI","Karachi");
        g.addCity("ISL","Islamabad");

        // Add edges or air ways in the graph
        g.connectCity("ISL","KHI");
        g.connectCity("KHI", "LHR");
        g.connectCity("LHR","AD");
        g.connectCity("LHR","SFO");
        g.connectCity("AD", "AUS");
        g.connectCity("AD", "SFO");
        g.connectCity("AD", "LHR");
